module github.com/raywall/custom-business-metrics-example/service

go 1.24

require github.com/raywall/custom-business-metrics/service v1.0.0
...
replace github.com/raywall/custom-business-metrics/service => ../../service
